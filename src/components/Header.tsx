...
const weekend = (hours.getDay() === 0 || hours.getDay() === 6)
const isOpen = (hours.getHours() >= 13 && hours.getHours() <= 21 && !weekend ) ? <p className='text-white bg-green-600 p-2 rounded-md'>Seg à Sex - 13h às 21h</p> : <p className='text-white bg-red-600 p-2 rounded-md'>Seg à Sex - 13h às 21h</p>
